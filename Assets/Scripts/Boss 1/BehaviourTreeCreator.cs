...
public class BehaviourTreeCreator
{
    public static Node GetBoss1()
    {
        ...
        Node randomCooldown = new RandomCooldown(onBoss, 5, 10);
        ...
        Node randomAttack = new RandomFallback(jump, strikeLeft, strikeRight, laserSweep);
        ...
        Node parallelRoot = new Parallel(0, randomCooldown, actionSelector);
